        ...
        const tables: Table[] = [
            {
                ...
                name: "users",
                columns: [
                    makeColumn({ column: "id", type: "integer", isSerial: true }),
        ...
        const tables: Table[] = [
            {
                ...
                name: "posts",
                columns: [
                    makeColumn({ column: "user_id", type: "integer" }),
                ],
                primaryKey: null,
                foreignKeys: [
                    {
        ...
        const tables: Table[] = [
            {
                ...
                name: "users",
                columns: [
                    makeColumn({ column: "email", type: "text" }),
                ],
                primaryKey: null,
                foreignKeys: [],
                uniqueConstraints: [
        ...
        const tables: Table[] = [
            {
                ...
                name: "logs",
                columns: [
                    makeColumn({ column: "message", type: "text" }),
                ],
                primaryKey: null,
                foreignKeys: [],
                uniqueConstraints: [],
